...
#include <arpa/inet.h>
/*#define PAIRINGD_WPS_SOCKET "/var/bewan/tmp/pairingd_wps.sock"*/
#define PAIRINGD_SOCKET "/var/bewan/tmp/pairingd.sock"
/*
* Send WPS state message to pairingd
*/
...
/*	strcpy(pairingd_addr.sun_path, PAIRINGD_WPS_SOCKET);*/
...
#ifdef CONFIG_IBOX
	notify_result("WPS 2 mins time out!");
#endif	// CONFIG_IBOX
				...
				const u8 *p2p_dev_addr)
{
	if (p2p_dev_addr == NULL &&
		...
		wpa_printf(MSG_DEBUG, "WPS: PBC overlap - do not start PBC "
			   "mode");
#ifdef CONFIG_IBOX
		notify_result("PBC Session Overlap");
#endif	// CONFIG_IBOX
...
#ifdef CONFIG_IBOX
	notify_result("WPS status success");
#endif	// CONFIG_IBOX
