/*
* $Id: mtlk_osal.h 12054 2011-11-29 10:46:54Z strashko $
*
...
/*! \file  mtlk_osal.h
    \brief MetaLink Driver OS Abstraction Layer definitions
...
***********************************************************************/
static const char mtlk_osal_eth_zero_addr[] = {0, 0, 0, 0, 0, 0};
/*! 
\fn      int __MTLK_IFUNC mtlk_osal_compare_eth_addresses(void* addr1, void* addr2)
...
*/
static __INLINE int mtlk_osal_compare_eth_addresses(const uint8* addr1,
                                                    const uint8* addr2);
static __INLINE void mtlk_osal_copy_eth_addresses(uint8* dst, 
                                                  const uint8* src);
static __INLINE int mtlk_osal_is_zero_address(const uint8* addr);
static __INLINE int mtlk_osal_eth_is_multicast(const uint8* addr);
static __INLINE int mtlk_osal_eth_is_broadcast(const uint8* addr);
static __INLINE int mtlk_osal_is_valid_ether_addr(const uint8* addr);
static __INLINE int mtlk_osal_eth_is_group_addr(const uint8* addr)
{
  return (((uint8*)(addr))[0] & 0x01);
}
static __INLINE int mtlk_osal_eth_is_directed(const uint8* addr)
{
...
***********************************************************************/
static __INLINE int mtlk_osal_ipv4_is_multicast(uint32 addr);       /* Big-Endian uint32 address */
static __INLINE int mtlk_osal_ipv4_is_local_multicast(uint32 addr); /* Big-Endian uint32 address */
/**********************************************************************/
