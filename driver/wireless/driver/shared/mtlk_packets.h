/*
 * $Id: mtlk_packets.h 10990 2011-04-07 07:50:31Z andriit $
 *
...
#define MTLK_ETH_TYPE_OFFSET(x)             (*((uint16*)((uint8*)x + 12)) > MTLK_ETH_FRAME_SIZE ? (12) : (20))
...
/*
 *      TOS (Type Of Service field). 8 bytes. According to RFC 791 
 */
typedef struct _mtlk_tos_field_t
{
#if defined(__LITTLE_ENDIAN_BITFIELD)
  uint8 reserved : 2;                 /* This field is now used for DiffServ and ECN. */
  uint8 mgmt     : 3;                 /* delay, throughput, reliability */
  uint8 priority : 3;
...
mtlk_wlan_pkt_get_frame_ctl (uint8 *data)
{
  /* 
