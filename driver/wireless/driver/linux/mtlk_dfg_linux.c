/*
 * $Id: mtlk_dfg_linux.c 12387 2012-01-05 14:37:50Z nayshtut $
 *
...
static int mtlk_df_ui_debug_pp_stats_lim_read (char *page, char **start, off_t off,
                                               int count, int *eof, void *data)
{
  int res = 0;
...
#endif
  MTLK_INIT_STEPS_LIST_ENTRY(mtlk_dfg, DFG_OSAL_INIT)
#ifdef MTCFG_BENCHMARK_TOOLS
...
#endif
    MTLK_CLEANUP_STEP(mtlk_dfg, DFG_OSAL_INIT, MTLK_OBJ_PTR(pdfg), 
                      mtlk_osal_cleanup, ());
#ifdef MTLK_DEBUG
...
int mtlk_dfg_init(void)
{
  ...
  mmb_cfg.man_msg_size          = mtlk_get_umi_man_size();
  ...
  MTLK_INIT_TRY(mtlk_dfg, MTLK_OBJ_PTR(pdfg))
    ...
    MTLK_INIT_STEP(mtlk_dfg, DFG_OSAL_INIT, MTLK_OBJ_PTR(pdfg), 
                   mtlk_osal_init, ());
#ifdef MTCFG_BENCHMARK_TOOLS
