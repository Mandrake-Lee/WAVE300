/*
* $Id: mtlk_objpool.c 12418 2012-01-09 14:46:04Z nayshtut $
*
                           ...
                           uint32 additional_allocation_size)
{
  ...
  _mtlk_objpool_hash_key_t   new_obj_hash_key = _MTLK_MAKE_OBJPOOL_HASH_KEY(object_type, creator_slid);
                                                ...
                                                uint32 additional_allocation_size)
{
  ...
  objfact->objects_number--;
  MTLK_ASSERT(objfact->objects_number >= 0);
  objfact->total_size -= additional_allocation_size;
  MTLK_ASSERT(objfact->total_size >= 0);
