...
/* RSN IE Header */
#define RSN_IE_HEADER_LEN                           (2)
#define RSN_IE_ID_OFFSET                            (0)
#define RSN_IE_LENGTH_OFFSET                        (1)
...
/* IEEE RSN IE offsets */
#define RSN_IE_IEEE_GROUP_OFFSET                    (4)
...
/* Cipher suite values (from 802.11i) */
#define RSN_CIPHER_SUITE_NONE                       UMI_RSN_CIPHER_SUITE_NONE
#define RSN_CIPHER_SUITE_WEP40                      UMI_RSN_CIPHER_SUITE_WEP40
#define RSN_CIPHER_SUITE_TKIP                       UMI_RSN_CIPHER_SUITE_TKIP
#define RSN_CIPHER_SUITE_WRAP                       UMI_RSN_CIPHER_SUITE_WRAP
#define RSN_CIPHER_SUITE_CCMP                       UMI_RSN_CIPHER_SUITE_CCMP
#define RSN_CIPHER_SUITE_WEP104                     UMI_RSN_CIPHER_SUITE_WEP104
#define RSN_CIPHER_SUITE_SHRAM_DMA                  (RSN_CIPHER_SUITE_WEP104+1)
#define RSN_NUM_CIPHER_SUITE                        (RSN_CIPHER_SUITE_SHRAM_DMA+1)
