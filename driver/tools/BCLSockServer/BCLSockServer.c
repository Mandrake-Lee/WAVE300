...
int BCL_nExit = 0; /* if this variable sets to 1, BCL will exit */
int BCL_nWantToExit = 0; /* set this variable to 1 to exit the BCL via a BCL command */

unsigned int BCL_numOfThreads = 0; /* the number of threads in the system */
